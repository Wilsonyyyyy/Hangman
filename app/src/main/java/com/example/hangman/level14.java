...
public class level14 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp14 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int14 = sp14.getInt("levelfourteenscore", 0);
        if (Int14 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp14.edit();
            editor.putInt("levelfourteenscore", 1);
            editor.commit();
            Integer Int15 = Int+Int2+Int3+Int4+Int5+Int6+Int7+Int8+Int9+Int10+Int11+Int12+Int13+sp14.getInt("levelfourteenscore", 0);
            String strint = String.valueOf(Int15);
            //getdate
        ...
        Intent intent = new Intent(this, thispage14.class);
        recreate();
        startActivity(intent);
