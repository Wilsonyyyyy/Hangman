...
public class level6 extends AppCompatActivity {
    ...
    TextView tw1,tw2,tw3,tw4,tw5,tw6,tw7,tw8,tw9,lifetextview,questextview,tv_score;//changable
    ...
    public void finishinglevelone(){
        ...
        sp6 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int6 = sp6.getInt("levelsixscore", 0);
        if (Int6 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp5.edit();
            editor.putInt("levelsixscore", 1);
            editor.commit();
            Integer Int7 = Int+Int2+Int3+Int4+Int5+sp6.getInt("levelsixscore", 0);
            String strint = String.valueOf(Int7);
            //getdate
        ...
        Intent intent = new Intent(this, thispage6.class);
        recreate();
        startActivity(intent);
