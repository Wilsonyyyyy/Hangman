...
public class level15 extends AppCompatActivity {
    ...
    private void goskip() {
        Intent intent = new Intent(this, hard_done.class);
        recreate();
        startActivity(intent);
    }
    ...
    public void finishinglevelone(){
        ...
        Integer Int14 = sp14.getInt("levelfourteenscore", 0);
        sp15 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int15 = sp15.getInt("levelfifthteenscore", 0);
        if (Int15 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp15.edit();
            editor.putInt("levelfifthteenscore", 1);
            editor.commit();
            Integer Int16 = Int+Int2+Int3+Int4+Int5+Int6+Int7+Int8+Int9+Int10+Int11+Int12+Int13+Int14+sp15.getInt("levelfifthteenscore", 0);
            String strint = String.valueOf(Int16);
            //getdate
        ...
        Intent intent = new Intent(this, thispage15.class);
        recreate();
        startActivity(intent);
