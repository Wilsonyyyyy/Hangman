...
public class  level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // INSERTING VALUE TO THE VARIABLES
    ...
    public void finishinglevelone(){
        ...
        if (Int == 0) {
            ...
            editor.putInt("levelonescore", 1);
            editor.commit();
            Integer Int2 = sp1.getInt("levelonescore", 0);
            String strint = String.valueOf(Int2);
            //getdate
        ...
        Intent intent = new Intent(this, thispage.class);
        recreate();
        startActivity(intent);
