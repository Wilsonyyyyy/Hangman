...
public class level10 extends AppCompatActivity {
    ...
    TextView tw1,tw2,tw3,tw4,tw5,tw6,tw7,tw8,tw9,tw10,tw11,lifetextview,questextview,tv_score;;//changable
    ...
    public void finishinglevelone(){
        ...
        sp10 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int10 = sp10.getInt("leveltenscore", 0);
        if (Int10 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp10.edit();
            editor.putInt("leveltenscore", 1);
            editor.commit();
            Integer Int11 = Int+Int2+Int3+Int4+Int5+Int6+Int7+Int8+Int9+sp10.getInt("leveltenscore", 0);
            String strint = String.valueOf(Int11);
            //getdate
        ...
        Intent intent = new Intent(this, normal_done.class);
        recreate();
        startActivity(intent);
