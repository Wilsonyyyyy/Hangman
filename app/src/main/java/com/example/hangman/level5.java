...
public class level5 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp5 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int5 = sp4.getInt("levelfivescore", 0);
        if (Int5 == 0) {
            //sharedusername
            ...
            editor.putInt("levelfivescore", 1);
            editor.commit();
            Integer Int6 = Int+Int2+Int3+Int4+sp5.getInt("levelfivescore", 0);
            String strint = String.valueOf(Int6);
            //getdate
        ...
        Intent intent = new Intent(this, easy_done.class);
        recreate();
        startActivity(intent);
