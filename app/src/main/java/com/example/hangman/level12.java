...
public class level12 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp12 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int12 = sp12.getInt("leveltwelvenscore", 0);
        if (Int12 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp12.edit();
            editor.putInt("leveltwelvenscore", 1);
            editor.commit();
            Integer Int13 = Int+Int2+Int3+Int4+Int5+Int6+Int7+Int8+Int9+Int10+Int11+sp12.getInt("leveltwelvenscore", 0);
            String strint = String.valueOf(Int13);
            //getdate
        ...
        Intent intent = new Intent(this, thispage12.class);
        recreate();
        startActivity(intent);
