...
public class level8 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp8 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int8 = sp7.getInt("leveleightscore", 0);
        if (Int8 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp8.edit();
            editor.putInt("leveleightscore", 1);
            editor.commit();
            Integer Int9 = Int+Int2+Int3+Int4+Int5+Int6+Int7+sp8.getInt("leveleightscore", 0);
            String strint = String.valueOf(Int8);
            //getdate
        ...
        Intent intent = new Intent(this, thispage8.class);
        recreate();
        startActivity(intent);
