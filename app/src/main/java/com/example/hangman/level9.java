...
public class level9 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp9 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int9 = sp9.getInt("levelninescore", 0);
        if (Int9 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp9.edit();
            editor.putInt("levelninescore", 1);
            editor.commit();
            Integer Int10 = Int+Int2+Int3+Int4+Int5+Int6+Int7+Int8+sp9.getInt("levelninescore", 0);
            String strint = String.valueOf(Int10);
            //getdate
        ...
        Intent intent = new Intent(this, thispage9.class);
        recreate();
        startActivity(intent);
