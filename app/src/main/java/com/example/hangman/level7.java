...
public class level7 extends AppCompatActivity {
    ...
    public void finishinglevelone(){
        ...
        sp7 = getSharedPreferences(uid+"myuserdata", Context.MODE_PRIVATE);
        Integer Int7 = sp7.getInt("levelsevenscore", 0);
        if (Int7 == 0) {
            //getscore
            SharedPreferences.Editor editor = sp7.edit();
            editor.putInt("levelsevenscore", 1);
            editor.commit();
            Integer Int8 = Int+Int2+Int3+Int4+Int5+Int6+sp7.getInt("levelsevenscore", 0);
        ...
        Intent intent = new Intent(this, thispage7.class);
        recreate();
        startActivity(intent);
